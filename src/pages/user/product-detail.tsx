      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <div className="relative aspect-[4/3] w-full mb-4 bg-gray-100 group overflow-hidden">
              <img
                src={product.imageUrl || `https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&q=80`}
                alt={product.name}
            ...
            <div className="grid grid-cols-3 gap-4">
              <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=400&q=80" className="w-full aspect-[4/3] object-cover hover:opacity-80 transition cursor-pointer" alt="Thumbnail" />
              <img src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=400&q=80" className="w-full aspect-[4/3] object-cover hover:opacity-80 transition cursor-pointer" alt="Thumbnail" />
              <img src="https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=400&q=80" className="w-full aspect-[4/3] object-cover hover:opacity-80 transition cursor-pointer" alt="Thumbnail" />
            </div>
          </div>
