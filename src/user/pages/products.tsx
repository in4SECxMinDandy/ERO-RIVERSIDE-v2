...
import { useListProducts, useListProjectCategories } from "@workspace/api-client-react";
              ...
              {data.products.map((product) => (
                <div key={product.id} className="group border border-gray-100 bg-white hover:luxury-shadow transition-all duration-300 flex flex-col h-full">
                  <div className="relative h-64 overflow-hidden">
                    <img
                      src={product.imageUrl || `https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80`}
                      alt={product.name}
